...
const verification = () => {
  ...
  return (
    <main className="flex flex-row justify-center items-center w-full min-h-screen py-8">
      <form
      ...
      >
        ...
        <h2 className="text-1xl text-gray-500 mt-4 text-center">
          To verify your email address,We have sent a OTP(One Time Password) to{" "}
          {email || "francisamidu@gmail.com"}
        </h2>
