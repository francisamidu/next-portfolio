...
const Contact = () => {
  return (
    <div className="pt-20 pb-8 px-8 text-center md:max-w-screen-md md:m-auto mt-8 flex flex-col items-center justify-center">
      ...
      <div className="md:w-1/4 w-2/4">
        <Button link="mailto:francisamidu124@gmail.com" text="Say Hello" />
      </div>
      <div className="mt-20">
